...
function createParams(email, projectid, index) {
   ...
   //https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GettingStarted.Js.03.html#GettingStarted.Js.03.03
    ...
    const params = {
        ...
        Key: {
         ...
         UpdateExpression: "REMOVE staffinfo[0]" ,
...
export default async function deleteListItemInDynamo(email,projectid,index) {
  ...
  const params = createParams(email,projectid,index)
